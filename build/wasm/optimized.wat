(module
 ...
 (type $i32_f32_f32_f32_f32_f32_=>_none (func (param i32 f32 f32 f32 f32 f32)))
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 18212))
 (memory $0 1)
 (data (i32.const 1036) ",")
 ...
 (data (i32.const 1548) "<")
 (data (i32.const 1560) "\01\00\00\00 \00\00\00~\00l\00i\00b\00/\00d\00a\00t\00a\00v\00i\00e\00w\00.\00t\00s")
 (data (i32.const 1612) ",")
 (data (i32.const 1624) "\01\00\00\00\18\00\00\00~\00l\00i\00b\00/\00m\00a\00t\00h\00.\00t\00s")
 (data (i32.const 1660) "<")
 ...
 (data (i32.const 1792) "\04\00\00\00 \00\00\00\00\00\00\00 ")
 (export "CreateNodeArrayBuffer" (func $src/assembly/index/CreateNodeArrayBuffer))
 (export "CreateLinkArrayBuffer" (func $src/assembly/index/CreateLinkArrayBuffer))
 ...
 (export "InitializeNodeArrayBuffer" (func $export:src/assembly/index/InitializeNodeArrayBuffer))
 (export "ApplyVelocity" (func $export:src/assembly/index/ApplyVelocity))
 (export "UpdateLinks" (func $export:src/assembly/index/UpdateLinks))
 (start $~start)
 ...
 (func $src/assembly/index/CreateNodeArrayBuffer (param $0 i32) (result i32)
  local.get $0
  i32.const 20
  i32.mul
 ...
 (func $~lib/dataview/DataView#setFloat32 (param $0 i32) (param $1 i32) (param $2 f32)
  local.get $1
  i32.const 31
  i32.shr_u
  local.get $0
 ...
 (func $src/assembly/index/CreateLinkArrayBuffer (param $0 i32) (result i32)
  local.get $0
  local.get $0
  i32.mul
  i32.const 20
 ...
 (func $~lib/dataview/DataView#getFloat32 (param $0 i32) (param $1 i32) (result f32)
  local.get $1
  i32.const 31
  i32.shr_u
  local.get $0
 ...
 (func $export:src/assembly/index/InitializeNodeArrayBuffer (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
 ...
 (func $export:src/assembly/index/ApplyVelocity (param $0 i32) (param $1 f32) (param $2 f32) (param $3 f32) (param $4 f32) (param $5 f32)
  (local $6 f32)
  (local $7 f32)
  (local $8 i32)
  (local $9 i32)
 ...
 (func $export:src/assembly/index/UpdateLinks (param $0 i32) (param $1 i32) (param $2 f32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
